 ...
 return (
  <div id="sign-in-page">
   ...
   <Form
    fields={{
     username: {
      label: SignInTranslations.username.label[language],
     ...
     password: {
      label: SignInTranslations.password.label[language],
    ...
    links={[
     { label: SignInTranslations.links.sign_up[language], to: '/sign-up' },
     { label: SignInTranslations.links.forgot_password[language], to: '/forgot-password' }
    ]}
   />
  </div>
 )
